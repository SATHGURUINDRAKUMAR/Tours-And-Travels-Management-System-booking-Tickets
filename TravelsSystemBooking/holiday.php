...
<tr class="labels Guru"><th class="Guru">Sr.No.</th><th class="Guru">Package Name</th><th class="Guru">Amount Per Member</th><th class="Guru">Delete</th></tr>
<?php
$u=1;
...
<td class="Guru"><?php echo $y['name'];?></td>
<td class="Guru"><?php echo "INR ".$y['amount'];?></td>
<td class="Guru"><a href="deleteH.php?del=<?php echo $y['id'];?>" class="link">Delete</a></td>
</tr>
<?php } ?>
</table>
