...
<tr class="labels Guru"><th class="Guru">Sr.No.</th><th class="Guru">Package Name</th>
<th class="Guru">Journey By</th><th class="Guru">Total Amount</th><th class="Guru">Date</th><th class="Guru">Status</th>
...
<td class="Guru"><?php echo $y['date'];?></td><td class="Guru"><?php if($y['status']==1){echo "Approved";}else{echo "Pending";}?></td>

<td class="Guru"><a href="deleteH.php?d=<?php echo $y['id'];?>" class="link">Delete</a></td>
</tr>
<?php } ?>
</table>
<br />
